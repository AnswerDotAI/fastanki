...
__all__ = ['add_card', 'add_fb_card', 'add_cloze_card', 'find_notes', 'find_note_ids', 'find_cards', 'find_card_ids', 'get_note',
           'update_note', 'update_fb_note', 'del_note', 'sync', 'anki_tools']
...
def anki_tools(): print('&`[add_card, add_fb_card, add_cloze_card, find_notes, find_note_ids, find_cards, find_card_ids, get_note, del_note, update_fb_note, sync]`')
